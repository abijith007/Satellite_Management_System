...
client = MongoClient("mongodb+srv://admin:password_123@satellite-1fkvi.mongodb.net/test?retryWrites=true&w=majority")
db = client.satellite_management_system
mycol = db['satellite_tle']

x = mycol.find({'sid' : sys.argv[1]})
