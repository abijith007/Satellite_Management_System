...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2019 at 08:57 AM
...
(8, 'European Space Agency (ESA)', 'esa@gmail.com', ' 1234567890', 'ESA', 'ESA', 'password'),
...
CREATE TABLE `satellites` (
  ...
  `launch_date` varchar(30) DEFAULT NULL,
...
(20, 'Aeolus', 'Earth Observation', 'Earth Science', 'LEO', '-1', 0, 314, 317, 0.00022436616558223, 96.7, 92.4, 1367, -1, -1, '1999-03-11', 3, 43600, 'Government', 'Vega'),
...
(11, 'Abijith', 'TR', 'trabijith@gmail.com', '1999-03-11', 'RVCE', 'L&T South City', 'abijith', 'password');
